            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body justify-content-between">
                    <select class="filter-categories border-0 mb-0 me-5" onchange="location = this.value;">
                        ...
                        <option value="category-user/foam">Foam</option>
                        <option value="category-user/sunscream">Sun Screa</option>
                        <option value="category-user/nightScream">Night Scream </option>
                        <option value="category-user/Le">Le</option>
                    </select>
