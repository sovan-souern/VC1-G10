                                ...
                                <ul class="category-list">
                                    ...
                                    if (isset($categories) && is_array($categories) && !empty($categories)) {
                                        foreach ($categories as $category) {
                                            echo '<li>
                                                <a href="#" class="category-filter" data-category-id="' . htmlspecialchars($category["category_id"]) . '">
                                    ...
                                    ?>
                                    <li>
                                        <a href="#" class="category-filter all-products" data-category-id="all">
...
<style>
    ...
    * {
    ...
    .stock-status-badge {
        position: absolute;
        top: 5px;
        left: 5px; /* Positioned on the left to avoid overlap with discount badge */
        color: white;
        padding: 3px 8px;
        border-radius: 3px;
        font-weight: bold;
