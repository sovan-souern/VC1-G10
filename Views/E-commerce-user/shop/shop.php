...
<head>
    ...
    <link rel="stylesheet" href="Views/E-commerce-user/assets/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="Views/E-commerce-user/assets/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="Views/E-commerce-user/assets/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="Views/E-commerce-user/assets/css/magnific-popup.css" type="text/css">
    <link rel="stylesheet" href="Views/E-commerce-user/assets/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="Views/E-commerce-user/assets/css/slicknav.min.css" type="text/css">
...
<body>
                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Skin care scrum</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseTwo">Fresh Glow</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseThree">Skin Serum</a>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <div class="product__price"><a href="product-page.php?id=1">$ 59.0</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="Views/E-commerce-user/assets/img/instagram/insta-1.jpg">
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="Views/E-commerce-user/assets/img/instagram/insta-2.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="Views/E-commerce-user/assets/img/instagram/insta-3.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="Views/E-commerce-user/assets/img/instagram/insta-4.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="Views/E-commerce-user/assets/img/instagram/insta-5.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-4 p-0">
                    <div class="instagram__item set-bg" data-setbg="Views/E-commerce-user/assets/img/instagram/insta-6.jpg">
                        <div class="instagram__text">
                            <i class="fa fa-instagram"></i>
                            <a href="#">@ ashion_shop</a>
                        </div>
    ...
    <script src="Views/E-commerce-user/assets/js/jquery.magnific-popup.min.js"></script>
    <script src="Views/E-commerce-user/assets/js/jquery-ui.min.js"></script>
    <script src="Views/E-commerce-user/assets/js/mixitup.min.js"></script>
    <script src="Views/E-commerce-user/assets/js/jquery.countdown.min.js"></script>
    <script src="Views/E-commerce-user/assets/js/jquery.slicknav.js"></script>
    <script src="Views/E-commerce-user/assets/js/owl.carousel.min.js"></script>
    <script src="Views/E-commerce-user/assets/js/jquery.nicescroll.min.js"></script>
