                ...
                <div class="col-lg-2 col-md-2 col-sm-12 custom-width mb-4">
                                ...
                                <div class="accordion" id="categoriesAccordion">
                                    <section class="card">
                                        <h5 class="card-heading">
                                            <button class="category-toggle" type="button" data-toggle="collapse" data-target="#skinCareCollapse" aria-expanded="true" aria-controls="skinCareCollapse">
                                                <span>Skin Care Serum</span>
                                                <i class="fas fa-chevron-down toggle-icon" aria-hidden="true"></i>
                                            </button>
                                        </h5>
                                        <div id="skinCareCollapse" class="collapse show" data-parent="#categoriesAccordion">
                                            <div class="card-body">
                                                <ul class="category-list" role="list">
                                                    <?php
                                                    // Check if $categories is set, is an array, and is not empty
                                                    if (!empty($categories) && is_array($categories)) {
                                                        foreach ($categories as $category) {
                                                            $categoryId = htmlspecialchars($category['category_id'] ?? '');
                                                            $categoryName = htmlspecialchars($category['category_name'] ?? 'Unnamed Category');
                                                            $productCount = htmlspecialchars($category['product_count'] ?? '');
                                                            echo "
                                        <li>
                                            <a href=\"#\" class=\"category-filter\" data-category-id=\"{$categoryId}\" aria-label=\"Filter by {$categoryName}\">
                                                ...
                                                <span class=\"category-count\">{$productCount}</span>
                                                        ...
                                                        echo '<li class="no-items" role="alert">No categories available</li>';
                                                    }
                                                    ?>
                                                    <li>
                                                        <a href="#" class="category-filter all-products" data-category-id="all" aria-label="View all products">
                                                            <span class="category-name">All Products</span>
                                                            <span class="category-count">
                                                                <?php echo isset($products) && is_array($products) ? count($products) : '0'; ?>
                                                            </span>
                                                        </a>
                                                    </li>
                                                </ul>
                    ...
                    <!-- <div class="quick-filters">
                        ...
                        <div class="filter-list">
                            <div class="filter-item" data-filter="new-arrivals">
                                <i class="fas fa-star"></i> New Arrivals
                            </div>
                            <div class="filter-item" data-filter="best-sellers">
                                <i class="fas fa-trophy"></i> Best Sellers
                            </div>
                            <div class="filter-item" data-filter="on-sale">
                                <i class="fas fa-tags"></i> On Sale
                            </div>
                        </div> -->
                    <!-- </div> -->
                </div>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        quickFilters.forEach(filter => {
                            filter.addEventListener('click', function() {
                                ...
                                // Add your quick filter logic here
                            });
                        });

                        // Mobile sidebar toggle (assuming you have a toggle button elsewhere)
                        const sidebar = document.querySelector('.shop__sidebar');
                        // Example toggle button (you'd need to add this to your main HTML)
...
<style>
    ...
    * {
    ...
    .stock-status-badge {
        ...
        top: 5px;
        left: 5px;
        /* Positioned on the left to avoid overlap with discount badge */
        color: white;
        padding: 3px 8px;
        border-radius: 3px;
        font-weight: bold;
