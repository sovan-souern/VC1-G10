...
<head>
    ...
    <style>
        ...
        .see-more-btn {
            ...
            margin: 20px auto;
            display: inline-block;
            box-shadow: 0 4px 10px rgba(248, 164, 185, 0.3);
        }

        .see-more-btn:hover {
            background-color: #f5809e;
            transform: translateY(-3px);
            box-shadow: 0 6px 15px rgba(248, 164, 185, 0.5);
        }
        ...
        .icon_heart_alt.favorited {
            color: #f8a4b9;
        }

        .discount-product-hover li a:hover .icon_heart_alt,
        .general-product-hover li a:hover .icon_heart_alt {
            color: #ffffff;
        }
...
<body>
    ...
    <section class="hero-banner">
        <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="https://images.unsplash.com/photo-1598440947619-2c35fc9aa908?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" class="d-block w-100" alt="Organic Skincare">
                    <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1412&q=80')">
                                        <ul class="discount-product-hover">
                                            ...
                                            <li><a href="#" class="favorite-btn" data-product-name="Vitamin C Serum" data-product-price="$39.99" data-product-image="https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1412&q=80" data-product-discount="20"><span class="icon_heart_alt"></span></a></li>
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://i.pinimg.com/474x/a6/97/bd/a697bd0bfc20e23ac9e9f5ed9198abd0.jpg')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Hyaluronic Acid" data-product-price="$33.99" data-product-image="https://i.pinimg.com/474x/a6/97/bd/a697bd0bfc20e23ac9e9f5ed9198abd0.jpg" data-product-discount="15"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1620916566398-39f1143ab7be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Retinol Night Cream" data-product-price="$44.99" data-product-image="https://images.unsplash.com/photo-1620916566398-39f1143ab7be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" data-product-discount="25"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Gentle Exfoliating Scrub" data-product-price="$24.49" data-product-image="https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80" data-product-discount="30"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1601049541289-9b1b7bbbfe19?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Hydrating Face Mask" data-product-price="$26.99" data-product-image="https://images.unsplash.com/photo-1601049541289-9b1b7bbbfe19?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1471&q=80" data-product-discount="10"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1412&q=80')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Niacinamide Serum" data-product-price="$29.89" data-product-image="https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1412&q=80" data-product-discount="35"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1631730359585-38a4935cbec4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Peptide Eye Cream" data-product-price="$33.99" data-product-image="https://images.unsplash.com/photo-1631730359585-38a4935cbec4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" data-product-discount="15"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
                            ...
                            <div class="col-md-3">
                                <div class="discount-product-card">
                                    ...
                                    <div class="product-image" style="background-image: url('https://images.unsplash.com/photo-1611930022073-84f3bb4caa2b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80')">
                                        <ul class="discount-product-hover">
                                            <li><a href="#" class="image-zoom"><span class="arrow_expand"></span></a></li>
                                            <li><a href="#" class="favorite-btn" data-product-name="Skin Renewal Kit" data-product-price="$59.99" data-product-image="https://images.unsplash.com/photo-1611930022073-84f3bb4caa2b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" data-product-discount="40"><span class="icon_heart_alt"></span></a></li>
                                            <li><a href="#"><span class="icon_bag_alt"></span></a></li>
                                        </ul>
                                    </div>
                                    <div class="product-info">
            ...
            <div class="row">
                <div class="col-12">
                            ...
                            <?php foreach ($discounts as $key => $discount): ?>
                                <?php if ($product["product_id"] == $discount["product_id"]): ?>
                                    <?php if ($discount["end_date"] >= date("Y-m-d") && $discount["start_date"] <= date("Y-m-d") ): ?>
                                        ...
                                        ?>
                                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4 product-item <?php echo $index >= 4 ? 'hidden-product' : ''; ?>">
                                            <div class="discount-product-card">
                                                <?php if ($stock_status): ?>
                    ...
                    <div class="col-12 text-center">
                        <button id="see-more-btn" class="btn see-more-btn">See More...</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Function to update the favorite icon state
            function updateFavoriteIcons() {
                document.querySelectorAll('.favorite-btn').forEach(btn => {
                    const productName = btn.getAttribute('data-product-name');
                    const icon = btn.querySelector('.icon_heart_alt');
                    if (isFavorited(productName)) {
            ...
            document.querySelectorAll('.favorite-btn').forEach(btn => {
                btn.addEventListener('click', function(e) {
                    ...
                    const productDiscount = parseFloat(btn.getAttribute('data-product-discount')) || 0;
                    const icon = btn.querySelector('.icon_heart_alt');
                    ...
                    if (existingIndex !== -1) {
                        ...
                        icon.classList.remove('favorited');
                        showToast(`${productName} removed from favorites.`, 'Removed');
                    } else {
                        // Add to favorites
                        const product = {
                            name: productName,
                            ...
                            quantity: 50, // Default quantity for Favorites page
            ...
            // Initial update of favorite icons
            updateFavoriteIcons();
