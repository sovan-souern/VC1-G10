<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="col-lg-3 col-md-6 col-6 mb-4">
      <div class="card h-100">
        <div class="card-body">
          ...
          <span class="fw-semibold d-block mb-1">Profit (Q1 2022)</span>
    ...
    <div class="col-lg-3 col-md-6 col-6 mb-4">
      <div class="card h-100">
        <div class="card-body">
          ...
          <span class="d-block mb-1">Payments (Q1 2022)</span>
    ...
    <div class="col-lg-3 col-md-6 col-6 mb-4">
      <div class="card h-100">
        <div class="card-body">
          ...
          <span class="fw-semibold d-block mb-1">Transactions (Q1 2022)</span>
  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-md-12 mb-4">
      <div class="card h-100">
        <h5 class="card-header m-0 me-2 pb-3">Total Revenue (2020 vs 2021)</h5>
